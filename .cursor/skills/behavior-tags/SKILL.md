...
| `hp-scaling` | Non-damage survivability or combat effects scale strongly with **HP values** | Damage formulas; shield-value scaling alone |
| `hp-loss` | Repeated or defining direct enemy HP-loss effects where the text says the target loses HP | Self/ally HP costs; lost-HP damage formulas; minor riders |
